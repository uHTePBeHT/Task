...
public class GraphDemoFrame extends JFrame {
    ...
    public GraphDemoFrame() {
        ...
        randomButton.addActionListener(e -> {
            try {
                int size1 = Integer.parseInt(fieldSize.getText());
                double coef = Double.parseDouble(fieldCoef.getText());
                String str = randomStringGraph(size1, coef);
        ...
        findPathButton.addActionListener(e -> {
            try {
                ...
                AdjListsWeightGraph graph = (AdjListsWeightGraph) this.graph;
                List<Integer> answer = Task.solution(graph, n);
                if (answer == null) {
                    textAreaSystemOut.setText("Нет пути!");
                } else {
                    String ansStr = listToString(answer);
                    textAreaSystemOut.setText(ansStr);
                }
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
    ...
    private static String listToString(List<Integer> ans) {
        String answer = null;
        for (int i = 0; i < ans.size(); i++) {
            if (i == 0 && ans.size() != 1) {
                answer = Integer.toString(ans.get(i)) + "-";
            } else if (i == 0) {
                answer = Integer.toString(ans.get(i));
    ...
    private static String randomStringGraph(int size, double coef) {
        ...
        for (int i = 0; i < size; i++) {
            for (int j = i + 1; j < size; j++) {
                array[i][j] = random.nextDouble() < coef ? 1 : 0;
                if (array[i][j] == 1) {
                    edges++;
                }
            }
        ...
        output += (Integer.toString(edges) + "\n");
        for (int i = 0; i < size; i++) {
            for (int j = i + 1; j < size; j++) {
                if (array[i][j] == 1) {
                    int rnd = random.nextInt(101);
                    output += (Integer.toString(i) + " " + Integer.toString(j) + " " + rnd + "\n");
                    matrix[i][j] = rnd;
                    matrix[j][i] = rnd;
                } else {
                    matrix[i][j] = 0;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        randomButton.setText("Сген. взв. н-граф");
        panel3.add(randomButton, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JPanel panel4 = new JPanel();
        panel4.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1));
        panel3.add(panel4, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        fieldSize = new JTextField();
        panel4.add(fieldSize, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        fieldCoef = new JTextField();
        panel4.add(fieldCoef, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JPanel panel5 = new JPanel();
        panel5.setLayout(new GridLayoutManager(3, 3, new Insets(0, 0, 0, 0), -1, -1));
        panel1.add(panel5, new GridConstraints(4, 0, 3, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel8.add(nField, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        findPathButton.setText("Найти путь");
        panel8.add(findPathButton, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
